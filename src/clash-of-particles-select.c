...
int main() {
	...
	// On commence par aller chercher un ensemble de particules.
    FILE *p_file = NULL;
	
	// On demande à l'utilisateur le nom du fichier qu'il souhaite.
	// Exemple : data/newton-simple.txt si le fichier est dans data
	char tab[1024];
	...
	// On ne souhaite pas lire la première ligne
